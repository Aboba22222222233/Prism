...
const StudentDashboard = () => {
    ...
    const generateAdvice = async (recentCheckins: any[]) => {
        ...
        try {
            ...
            const prompt = `Ты психолог. Проанализируй состояние ученика и дай ОДИН короткий совет (максимум 2 предложения).

СТРОГИЕ ПРАВИЛА:
- Пиши ТОЛЬКО на русском языке
- НЕ используй английские слова, латиницу, немецкие слова
- НЕ используй технические термины
- Обращайся на "ты", будь тёплым
